...
<c:if test="${not empty registeredConnections}">
            ...
            <c:forEach var="connectionData" items="${entry.value}">
                <li class="span3 registeredConnection">
                    <div class="thumbnail">
                        ...
                        <button class="btn" onclick="confirmRemoveConnection('${connectionData.id}')">
    ...
    <%--<div id="removeConnectionModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="removeConnectionModalTitle" aria-hidden="true">--%>
        <%--<div class="modal-header">--%>
            ...
            <%--<h3 id="removeConnectionModalTitle"><fmt:message key="jnt_socialNetworkConnector.label.removeConnection.modal.title"/></h3>--%>
        <%--</div>--%>
        <%--<div class="modal-body">--%>
            <%--<fmt:message key="jnt_socialNetworkConnector.label.removeConnection.modal.body"/>--%>
        <%--</div>--%>
        <%--<div class="modal-footer">--%>
            <%--<button class="btn" data-dismiss="modal" aria-hidden="true"><fmt:message key="jnt_socialNetworkConnector.label.removeConnection.modal.cancel"/></button>--%>
            <%--<button id="removeConnectionModalConfirmButton" class="btn btn-danger"><fmt:message key="jnt_socialNetworkConnector.label.removeConnection.modal.confirm"/></button>--%>
        <%--</div>--%>
    <%--</div>--%>
</c:if>